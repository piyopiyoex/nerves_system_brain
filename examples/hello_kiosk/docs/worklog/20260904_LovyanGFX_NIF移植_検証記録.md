...
> **位置づけ**: この文書は調査・検証の詳細記録です。現在の判断は [`../adr/0001-LovyanGFX_NIF移植.md`](../adr/0001-LovyanGFX_NIF移植.md) を参照してください。
...
- 証拠: [assets/lovyangfx_ja_phase0.png](assets/lovyangfx_ja_phase0.png)(実機 fb0 キャプチャ)
- 確認内容:
...
- **Moving Icons デモ実機動作 OK**: 画面キャプチャ
  [assets/lovyangfx_moving_icons.png](assets/lovyangfx_moving_icons.png)。
