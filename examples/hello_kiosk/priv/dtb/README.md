...
| `pwsh6-peripheral.dtb` | peripheral | USB NCM ガジェット(母艦と直結、usb0 は VintageNetDirect が管理) | 上と同一で `dr_mode = "peripheral"` のみ差し替え(md5 0ad4081f、旧 `imx28-pwsh6.dtb.ncm-buzzer`) |
